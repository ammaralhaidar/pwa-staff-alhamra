    ...
    <div className="relative mx-auto flex h-svh max-w-[430px] flex-col bg-[#EFF6FF]">
      <div className="shrink-0 z-40">
        <MusyrifHeader
          ...
          subtitle="Informasi transaksi dompet"
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        <section className="space-y-3 px-4 py-6">
          ...
          {!query.isLoading && !items.length ? <Card className="rounded-[22px] border-0 bg-white p-6 text-center font-semibold text-slate-500 shadow-sm">Tidak ada transaksi dompet.</Card> : null}
        </section>
      </div>
